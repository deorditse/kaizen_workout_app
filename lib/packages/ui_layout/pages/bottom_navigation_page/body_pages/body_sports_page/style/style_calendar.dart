...
BoxDecoration myBoxDecorationtyleCheckBox([myColor, myBorderStyle]) {
  return BoxDecoration(
    ...
    color:
    myColor != null ? myColor : Colors.green,//colorController.myStateColorCheckBox.value,
    borderRadius: BorderRadius.circular(100),
    boxShadow: [
      BoxShadow(
        color: myColor != null ? myColor : Colors.green, //: colorController.myStateColorCheckBox,
        spreadRadius: 2,
        blurRadius: 5,
